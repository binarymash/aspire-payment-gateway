using AspirePaymentGateway.ServiceDefaults;
...
public static class Extensions
{
    public static TBuilder AddServiceDefaults<TBuilder>(this TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
        ...
        builder.Services.AddSwaggerGen(options =>
        {
            ...
            options.SchemaFilter<Rfc9457SchemaFilter>();
        });
    ...
    public static WebApplication MapOpenApiForDevelopment(this WebApplication app, string openApiUiEndpoint)
    {
        ...
        if (app.Environment.IsDevelopment())
        {
            ...
            //    {
            //        return Results.Redirect(openApiUiEndpoint);
            //    });
        }
